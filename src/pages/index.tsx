...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return setIsAuthenticated(status === "true");
  }, []);
  ...
  return (
    <>
      ...
      <main className="flex flex-row gap-3.5 justify-between bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white h-screen">
        ...
        <section className="container max-w-xs divide-y divide-gray-200 h-full max-h-full overflow-auto shadow-md shadow-gray-600/50 transition duration-300 hover:shadow-xl hover:shadow-gray-500/90 bg-white">
